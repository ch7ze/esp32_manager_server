...
export class ShapeFactory {
     ...
     */
    static createFromEventData(event) {
    ...
    static extractShapeData(shape) {
        ...
        if (shapeAny.from && shapeAny.to && !shapeAny.p1) {
            // Line or Rectangle
            return Object.assign(Object.assign({}, data), { from: { x: shapeAny.from.x, y: shapeAny.from.y }, to: { x: shapeAny.to.x, y: shapeAny.to.y } });
        }
        else if (shapeAny.center && typeof shapeAny.radius === 'number') {
            // Circle
            return Object.assign(Object.assign({}, data), { center: { x: shapeAny.center.x, y: shapeAny.center.y }, radius: shapeAny.radius });
        }
        else if (shapeAny.p1 && shapeAny.p2 && shapeAny.p3) {
            // Triangle
            return Object.assign(Object.assign({}, data), { p1: { x: shapeAny.p1.x, y: shapeAny.p1.y }, p2: { x: shapeAny.p2.x, y: shapeAny.p2.y }, p3: { x: shapeAny.p3.x, y: shapeAny.p3.y } });
        }
        return data;
    }
    /**
